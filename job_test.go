...
func TestJobConnectionsCount(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	err := client.Jobs.ConnectionsCount(context.TODO(), int64(0))
	if err != nil {
		var apierr *schedo.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestJobDefineInternalWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Jobs.DefineInternal(context.TODO(), schedo.JobDefineInternalParams{
		Name:     schedo.F("Name of your job"),
		Schedule: schedo.F("0 0 * * *"),
		Blocking: schedo.F(true),
		Metadata: schedo.F(map[string]interface{}{
...
func TestJobListFull(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Jobs.ListFull(context.TODO(), schedo.JobListFullParams{
		XAPIEnvironment: schedo.F(int64(0)),
	})
	if err != nil {
		var apierr *schedo.Error
